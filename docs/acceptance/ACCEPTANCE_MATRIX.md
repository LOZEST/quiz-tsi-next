...
| BOARD-011 | Tableau | Palette latérale mathématique simplifiée | tableau ouvert | inspecter puis ouvrir Stylo et Formes | seuls Stylo et Formes sont permanents ; Stylo révèle Stylo/Gomme ; Formes contient les dix formes mathématiques dont un tableau de signes structuré, sans choix de taille | RTL structure/comportement et tests de géométrie/round-trip | inspection iPad portrait | PR6 | À implémenter |

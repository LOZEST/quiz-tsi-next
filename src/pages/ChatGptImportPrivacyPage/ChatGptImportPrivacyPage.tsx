  ...
  return (
    <main id="main-content">
      ...
      <p>
        ...
        original n’est pas envoyé à Prépa Math.
      </p>
      <p>
        Après ton aperçu et ta confirmation, Prépa Math reçoit uniquement le
        contenu structuré des questions, leur classification, la couverture
        d’analyse et les incertitudes signalées.
      </p>
      <p>
        Ton compte Prépa Math est lié à l’action par OAuth. L’import crée
